...
$sql="INSERT INTO `landregister`(  `State`, `District`, `Village`, `Area`, `Wresource`, `Scrop`,`Apyear`,`Noyear`, `Username`,`remarks`) VALUES ('$name','$dist','$vil','$d','$e','$k','$l','$f','$id','Not Booked')";
...
tr:nth-child(even) {background-color: #ADFF2F;}
img {
	border-radius:50%;
    }
...
<td style="padding:8px"><table width="100%" border="2" bgcolor="#bfff00" >
        <tr> 
		  ...
		  <td><strong><font color="#000000">Edit</font></strong></td>
...
?>
        ...
        $result1=mysqli_query($con,"SELECT * from landregister where Username='$id' order by Landid desc");
    ...
    ?>
        <tr> 
		 ...
		 <td><a href="<?php 
		  ...
		  echo "editland.php?Landid=$u"?>"> EDIT </a>
		  </td>
...
<td><table bgcolor="#bfff00"  style=" border-radius: 15px 25px;"><tr><td><form id="form2" name="regla" method="POST" action="#" onSubmit="return valid()">
