...
$sql4=mysqli_query($con,"SELECT * FROM landregister WHERE Landid='$id1'");
...
$sql5=mysqli_query($con,"SELECT * FROM register,booking WHERE register.Username='$d'and booking.email='$d'");
...
$sql6=mysqli_query($con,"SELECT * FROM landregister WHERE landregister.Landid='$id1'");
